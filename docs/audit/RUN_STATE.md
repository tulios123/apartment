...
- **Pending seed:** grace, balloon, day_of_month=31, ~400-tx stress. No new findings from the seed-independent tests (the money engine is cross-screen + cross-period consistent).
